...
import com.sample.tmdb.data.paging.movie.PopularMoviesPagingSource
...
@Singleton
class PopularMoviesPagingRepository
    @Inject
    constructor(
        ...
        override fun pagingSource(
            query: String?,
            id: Int?,
        ): BasePagingSource<Movie> = PopularMoviesPagingSource(context, movieApi)
    }
