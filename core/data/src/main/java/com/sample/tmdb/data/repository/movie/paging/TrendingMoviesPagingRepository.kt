...
import com.sample.tmdb.data.paging.movie.TrendingMoviesPagingSource
...
@Singleton
class TrendingMoviesPagingRepository
    @Inject
    constructor(
        ...
        override fun pagingSource(
            query: String?,
            id: Int?,
        ): BasePagingSource<Movie> = TrendingMoviesPagingSource(context, movieApi)
    }
